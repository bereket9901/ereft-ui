...
export function SidebarResponsive(props: { routes: RoutesType[] }) {
	...
	return (
		<Flex display={{ sm: 'flex', xl: 'flex' }} alignItems='center'>
			...
			<Drawer
				...
				<DrawerOverlay />
				<DrawerContent w='225px' maxW='225px' bg={sidebarBackgroundColor}>
					<DrawerCloseButton
						zIndex='3'
						onClick={onClose}
					...
					/>
					<DrawerBody onClick={onClose}  maxW='285px' px='0rem' pb='0'>
						<Scrollbars
							autoHide
							renderTrackVertical={renderTrack}
							renderThumbVertical={renderThumb}
